...
const Menu = () => {
    ...
    return (
        <>
        <a><i onClick={clickMenu} className={`main-menu-bar ${icon?'fas fa-bars active':'fab fa-xing'}`}></i></a>
        <div className={state?'top-menu-main':'top-menu-main active'}>
            ...
            <div className="main-menu-left">
                ...
                <ul className="left-menu-block">
                 ...
                 <li><Link to='/expertise' onClick={clickMenu}>EXPERTISE</Link></li>
                 </ul>
            </div>
            ...
            <div className="main-menu-right">
                <ul className="right-menu-block">
                    ...
                    <li><Link to='/faq' onClick={clickMenu}>FAQ's</Link></li><div className='menu-line'></div>
