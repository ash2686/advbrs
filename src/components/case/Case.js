            ...
            <div className="case-main-block">
                <div className="case-line"></div>
                  <div className="case-text-block">
                      <h1>Case Results</h1>
                       <p style={{width:"100%"}}>Case results speak for themselves. I’ve helped my clients obtain millions of dollars in settlements and judgments.</p>
                       ...
                       <p style={{color: "red", fontWeight:"bolder"}}>Don’t settle for less than you deserve.</p>
